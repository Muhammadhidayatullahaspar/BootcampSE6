...
class Program
{
	static void Main()
	{
		...
		//List<Piece> player1 = gameController.GetPieces(Player1);
		//List<Piece> player2 = gameController.GetPieces(Player2);
		...
		#endregion
		Console.WriteLine("=================================================");
		Console.WriteLine("         SELAMAT DATANG DI PERMAINAN");
		Console.WriteLine("            CHECKERS SUPER SERU!");
		Console.WriteLine("=================================================");
		Console.WriteLine($"       Halo {playerName1} (white) dan {playerName2} (black)");
		Console.WriteLine("Selamat bermain dan jangan nangis ya jika kalah!");
		Console.WriteLine("=================================================");
		...
		while (true)
		{
			...
			if (gameController.MovePiece(pieceToMove.Position, newPosition))
			{
				...
				// Periksa apakah salah satu pemain telah kehabisan piece
				var player1PiecesInfoAfter = gameController.GetPlayerPiecesDisplay(player1);
				var player2PiecesInfoAfter = gameController.GetPlayerPiecesDisplay(player2);

				if (player1PiecesInfoAfter.Count == 0 || player2PiecesInfoAfter.Count == 0)
				{
					IPlayer winningPlayer = player1PiecesInfoAfter.Count == 0 ? player2 : player1;
					Console.WriteLine("\n====================================================");
					Console.WriteLine("              + PERMAINAN BERAKHIR +");
					Console.WriteLine("====================================================");
					Console.WriteLine("                     PEMENANG ");
					Console.WriteLine($"                       {winningPlayer.Name.ToUpper()}");
					Console.WriteLine("====================================================");
					Console.WriteLine($"       {winningPlayer.Name.ToUpper()} MENANG KARENA LAWAN KEHABISAN PIECE");
					Console.WriteLine("====================================================\n");
