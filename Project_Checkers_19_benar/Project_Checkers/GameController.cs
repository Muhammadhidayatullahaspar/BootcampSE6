...
public class GameController
{
	...
	#region Penempatan Potongan pada Papan
	/// <summary>
	...
	private void PlacePiecesOnBoard(List<Piece> pieces, int startingRow)
	{
		...
		for (int row = startingRow; row < startingRow + 3; row++)
		{
			...
			{
				// Hanya menempatkan potongan pada kotak berwarna gelap
	...
	/// berisi posisi, ID piece, warna, jenis piece, status kosong, dan ID kotak (jika kotak valid).
	/// </returns>
	...
	#region Mendapatkan Tampilan Potongan Pemain
	/// <summary>
