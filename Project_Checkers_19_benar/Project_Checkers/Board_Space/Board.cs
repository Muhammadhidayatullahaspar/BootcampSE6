...
public class Board
{
	...
	/// Inisialisasi array potongan dengan ukuran 64.
	/// </summary>
	public Board()
	{
	...
	/// <summary>
	/// Menetapkan potongan pada posisi tertentu di papan permainan.
	/// </summary>
	/// <param name="position">Objek posisi (Position) tempat potongan akan ditempatkan.</param>
	/// <param name="piece">Objek potongan (Piece) yang akan ditempatkan.</param>
	...
	/// <summary>
	/// Mengembalikan potongan pada posisi yang ditentukan di papan permainan.
	/// </summary>
	/// <param name="position">Objek posisi (Position) tempat potongan akan dicari.</param>
	/// <returns>Objek potongan (Piece) pada posisi tertentu, atau null jika posisi tidak valid.</returns>
