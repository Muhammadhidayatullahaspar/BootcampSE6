...
public class Board
{
	...
	public Board()
	{
		_pieces = new Piece[64]; // tambahkab board.gamezise yang bisa dipakai pada game controller, seperti untuk ubah basic jadi king
	} // dan bisa ubah papan permainan seperti 8x 8 jadi 10 x 10
	#endregion
